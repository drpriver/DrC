#pragma once
// 8x16 bitmap font
// ASCII 32-127. Each char is 16 bytes, 1 bit per pixel, MSB left.
enum { FONT_W = 8, FONT_H = 16, FONT_FIRST = 32, FONT_COUNT = 96 };
static const unsigned char font8x16[FONT_COUNT][FONT_H] = {
    ...
    {0x00,0x00,0x00,0x00,0x10,0x38,0x6c,0xc6,0xc6,0xc6,0xfe,0x00,0x00,0x00,0x00,0x00}, // DEL
};
