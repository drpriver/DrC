...
warn_unused static inline CcFunction* _Nullable cc_intern_function(CcTypeCache*, Allocator, CcQualType return_type, const CcQualType* params, uint32_t param_count, uint32_t fixed_param_count, _Bool is_variadic, _Bool no_prototype);
